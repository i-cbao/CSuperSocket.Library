...
namespace Dapper
{
    ...
    public static partial class SqlMapper
    {
        ...
        {
            AddTypeHandlerImpl(typeof(IEnumerable<Npgsql.NpgsqlDataReader>), new SqlDataRecordHandler(), clone);
        }
...
#pragma warning restore 618
        ...
        )
        {
            ...
            else
            {
                ...
                //找到标记有ExplicitConstructor的构造函数-zhouhuajun des
...
#pragma warning restore 618
        ...
        public static ICustomQueryParameter AsTableValuedParameter(this IEnumerable<Npgsql.NpgsqlDataReader> list, string typeName = null) =>

...
namespace CDynamic.Dapper
{
    ...
    {
        private readonly ConcurrentDictionary<string, Clauses> _data = new ConcurrentDictionary<string, Clauses>();
        private int _seq;
        ...
        public class Template
        {
            ...
            private static readonly Regex TemplateRegex = new Regex(@"\/\*\*.+?\*\*\/", RegexOptions.Compiled | RegexOptions.Multiline);
            ...
            private void ResolveSql()
            {
                ...
                _rawSql = TemplateRegex.Replace(_rawSql, "");

...
namespace Swashbuckle.AspNetCore.ChmUI
{
    public class SwaggerUIOptions
    {
        ...
        public Func<Stream> IndexStream { get; set; } = () => typeof(SwaggerUIOptions).GetTypeInfo().Assembly
            .GetManifestResourceStream("Swashbuckle.AspNetCore.ChmUI.Template.index.html");
        ...
        /// <summary>
        /// Provide one or more Chm JSON endpoints. Can be fully-qualified or relative to the UI page
        /// </summary>
        ...
        /// <summary>
        /// Change the title of the Chm UI
        /// </summary>
        /// <param name="value">Title given to Chm UI</param>

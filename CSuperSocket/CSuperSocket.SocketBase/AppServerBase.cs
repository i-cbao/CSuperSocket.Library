        ...
        private void SetupBasic(IRootConfig rootConfig, IServerConfig config, ISocketServerFactory socketServerFactory)
        {
            ...
            if (socketServerFactory == null)
            {
                var socketServerFactoryType =
                    Type.GetType("CSuperSocket.SocketEngine.SocketServerFactory, CSuperSocket.SocketEngine", true);
...
#pragma warning restore 0612, 618
        ...
        /// search both in the appserver's root and in the CSuperSocket root dir if the isolation level has been set other than 'None'.
        /// </summary>
